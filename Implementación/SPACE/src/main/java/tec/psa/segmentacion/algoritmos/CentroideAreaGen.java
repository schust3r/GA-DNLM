...
public class CentroideAreaGen {
  ...
  /**
   * Sobrecarga del metodo anterior que recibe una Mat en lugar
   * de un arreglo de bytes.
   * 
   * @param imagen la matriz Mat de OpenCV
   * @return un string con los centroides y areas
   */
  public String obtenerCentroidesAreas(Mat imagen) {
